...
Rally helps recreational tennis players find compatible hitting partners using a weighted matching engine, and generates an AI pre-session brief (OpenAI) for each proposed session.
