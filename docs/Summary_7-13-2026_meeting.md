...
| **3 · Sessions View** (booking UI, renders the AI brief) | *Unassigned — no commits found* | Unblocked | Booking flow works. Role 2 is shipped. Note: AI brief is now a standalone tab rather than inline in CalendarView — confirm this satisfies the rubric or add an inline brief to confirmed session cards too. |
